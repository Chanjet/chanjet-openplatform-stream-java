...
impl ONNXEmbedder {
    pub fn new() -> Result<Self> {
        ...
        Self::ensure_asset(&model_path, include_bytes!("../../../../cli/cjtc/pkg/search/assets/models/model_quantized.onnx"))?;
        Self::ensure_asset(&data_path, include_bytes!("../../../../cli/cjtc/pkg/search/assets/models/model_quantized.onnx_data"))?;
        Self::ensure_asset(&tokenizer_path, include_bytes!("../../../../cli/cjtc/pkg/search/assets/models/tokenizer.json"))?;
