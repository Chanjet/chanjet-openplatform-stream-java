use cowen_auth::provider::oauth2::{Pkce, OAuth2Provider};
use cowen_auth::provider::AuthProvider;
use cowen_auth::pool::TokenPool;
use cowen_common::{CowenResult, CowenError};
use cowen_common::domain::*;
use cowen_common::models::{Ticket, Token, AuthSession};
...
fn test_oauth2_capabilities() {
    ...
    impl ConfigDomain for MockVault {
        ...
        async fn get_config_full(&self, _: &str, _: &str) -> CowenResult<Item> { Err(CowenError::Auth(format!("not found"))) }
