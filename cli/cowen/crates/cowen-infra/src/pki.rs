...
pub const OFFICIAL_ROOT_PUB_KEY: &[u8] = &[0x85, 0x9A, 0x55, 0x3B, 0xAD, 0x10, 0x4B, 0x9A, 0xC0, 0x5C, 0x5B, 0xD0, 0x95, 0x83, 0x7A, 0x6C, 0x29, 0x8B, 0xD2, 0x1E, 0xC4, 0xF3, 0x03, 0x20, 0x40, 0x19, 0xE2, 0x5A, 0xC0, 0x83, 0xE0, 0x12];
