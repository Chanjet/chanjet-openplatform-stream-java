...
impl ONNXEmbedder {
    ...
    pub fn rebuild_index(&mut self, spec: &serde_json::Value) -> anyhow::Result<crate::index::SearchIndex> {
        let paths = spec["paths"].as_object().ok_or_else(|| anyhow::anyhow!("Invalid spec: paths not found"))?;
