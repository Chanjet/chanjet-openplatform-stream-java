...
| :--- | :--- | :--- | :--- |
| **打包命令** | `make package-macos-aarch64` | `make package-linux-x86_64`<br>`make package-linux-aarch64` | `make package-windows-x86_64-cross`<br>`make package-windows-x86_64` |
| **产物格式** | 双击安装包：`.pkg` | 压缩归档包：`.tar.gz` | 自解压安装包：`.exe` (Setup) |
...
| 插件名称 | macOS 产物文件名 | Linux 产物文件名 | Windows 产物文件名 | 目标安装路径 |
| :--- | :--- | :--- | :--- | :--- |
| **自建模式鉴权Wasm** | `cowen_wasm_auth_selfbuilt.wasm`<br>`cowen_wasm_auth_selfbuilt.bundle` | `cowen_wasm_auth_selfbuilt.wasm`<br>`cowen_wasm_auth_selfbuilt.bundle` | `cowen_wasm_auth_selfbuilt.wasm`<br>`cowen_wasm_auth_selfbuilt.bundle` | `~/.cowen/system_plugins/` |
| **应用商店鉴权Wasm** | `cowen_wasm_auth_storeapp.wasm`<br>`cowen_wasm_auth_storeapp.bundle` | `cowen_wasm_auth_storeapp.wasm`<br>`cowen_wasm_auth_storeapp.bundle` | `cowen_wasm_auth_storeapp.wasm`<br>`cowen_wasm_auth_storeapp.bundle` | `~/.cowen/system_plugins/` |
| **自定义模式鉴权Wasm** | `cowen_wasm_auth_custom.wasm` | `cowen_wasm_auth_custom.wasm` | `cowen_wasm_auth_custom.wasm` | `~/.cowen/system_plugins/` |
| **AI 检索与向量插件** | `libcowen_search_embedding`<br>`libcowen_search_embedding.bundle` | `libcowen_search_embedding`<br>`libcowen_search_embedding.bundle` | `libcowen_search_embedding.exe`<br>`libcowen_search_embedding.bundle` | `~/.cowen/plugins/` |
| **MCP 独立插件** | `cowen-mcp-plugin`<br>`cowen-mcp-plugin.bundle` | `cowen-mcp-plugin`<br>`cowen-mcp-plugin.bundle` | `cowen-mcp-plugin.exe`<br>`cowen-mcp-plugin.bundle` | `~/.cowen/plugins/` |
...
### 3. Windows 分发逻辑 (`.exe` Setup)

Windows 分发主要使用自解压安装包模式部署：

#### Setup 自解压安装包模式 (`.exe` - 官方分发首选)
