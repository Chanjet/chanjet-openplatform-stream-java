...
| **1.3** | **FileStore 物理拆分** | `cowen-store`, `cowen-common`。提升 I/O 稳定性。 | `file.rs`, `migration.rs` | 1.5 | 1.4 | 1. [重构] 核心方法嵌套深度 ≤ 3 层。<br>2. [验证] 旧版数据自动在线迁移成功。<br>3. [注] 必须先完成 1.4 的 Trait 抽象才能进行扁平化重写。 |
